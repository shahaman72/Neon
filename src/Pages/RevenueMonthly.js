    ...
    <HStack w={"100%"} h={"80vh"}>
      <VStack w={"80%"} h={"80vh"}>
        <Modal isOpen={isOpen} onClose={onClose} size={"full"}>
          <ModalOverlay />
          <ModalContent>
            <ModalHeader>Report of Revenue</ModalHeader>
            <ModalFooter>
            ...
            <Box w={"100%"}>
              <HStack w={"100%"} justify={"end"}>
                <Flex
                  ...
                  mt={2}
                >
                  <Text>What was the revenue in december?</Text>
                </Flex>
              </HStack>
              <HStack w={"100%"} justify={"start"}>
                <Flex maxW={"50%"} p={4} borderRadius={"10px"} bg={"#DDDDDD"}>
                  <HStack align={"flex-start"} spacing={4}>
                    <Box bg={"#403A83"} borderRadius={"full"} p={1}>
                      <Icon
                        as={GiGrowth}
                        w={"24px"}
                        h={"20px"}
                    ...
                    <VStack justify={"start"} align={"start"}>
                      ...
                      <Text textAlign={"left"}>$ 3.9 B</Text>
                      <HStack>
                        <IconButton
            ...
            <Box w={"100%"}>
              <HStack w={"100%"} justify={"end"}>
                <Flex
                  ...
                  mt={2}
                >
                  <Text>Display the sales by region.</Text>
                </Flex>
              </HStack>
              <HStack w={"100%"} justify={"start"}>
                <Flex maxW={"50%"} p={4} borderRadius={"10px"} bg={"#DDDDDD"}>
            ...
            <Box w={"100%"}>
              <HStack w={"100%"} justify={"end"}>
                <Flex
                  ...
                  mt={2}
                >
                  <Text>Show the last 12 months trends.</Text>
                </Flex>
              </HStack>
              <HStack w={"100%"} justify={"start"}>
                <Flex maxW={"50%"} p={4} borderRadius={"10px"} bg={"#DDDDDD"}>
            ...
            <Box w={"100%"}>
              <HStack w={"100%"} justify={"end"}>
                <Flex
                  ...
                  mt={2}
                >
                  <Text>Average monthly growth in last year.</Text>
                </Flex>
              </HStack>
              <HStack w={"100%"} justify={"start"}>
                <Flex maxW={"50%"} p={4} borderRadius={"10px"} bg={"#DDDDDD"}>
          ...
          {count >= 5 && questionArr && (
            <Box w={"100%"}>
              <HStack w={"100%"} justify={"end"}>
                ...
                >
                  <Text>
                    What are the sales by district when total sales is the
